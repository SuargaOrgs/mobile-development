...
class CalendarBabyEditText : AppCompatEditText, DatePickerDialog.OnDateSetListener {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        hint = context.getString(R.string.date_baby_hint) // Mengatur hint untuk tanggal
